...
E2 相比 Base 严格口径多识别 25 张 BAD、少误报 82 张 GOOD，Accuracy 提升 53.50 个百分点；相比 E1 则多识别 4 张 BAD，同时少误报 4 张 GOOD，共减少 8 个错误。E2 达到 Recall≥72%、FPR≤25%、Accuracy≥72% 的 Go 标准，但 Recall 尚未达到 78% 挑战目标。
...
3. **微调同时改善分类与输出协议遵循。** Base 的完整 schema 合法率仅 62.50%，严格口径 Accuracy 为 36.50%；E2 在同一修正版 Dev 和推理协议下达到 90.00%，说明收益不只是标签修正造成的。
